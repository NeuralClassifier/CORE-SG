...
class CORE_SG():
    ...
    def k_max_NNG(self):
        ...
        #return kmax_NNG, core_dist, euclidean_pairwise_dist
        #return kmax_NNG, euclidean_pairwise_dist
...
if __name__ == "__main__":
    ...
    for dataset in df_names:   
        ...
        c_sg = CORE_SG(df,120)
        c_sg.compute_core_sg()

        print("MST-kmax: ")
        print()
        print(c_sg.MinSpanningTree_kmax)
        print()
        print("MRD weighted kmax-NNG: ")
        print()
        print(c_sg.kmax_MRDWeightdNearestNeighbourG)
        print()
        print("CORE-SG: ")
        print()
        print(c_sg.core_sg)
